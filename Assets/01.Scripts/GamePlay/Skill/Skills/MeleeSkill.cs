...
public abstract class AttackSkill : ActiveSkillBase
{
    ...
    public AttackSkill(ActiveSkillData data, IServiceLocator context, IServiceLocator owner, ISkillTriggerStrategy trigger) : base(data, context, owner, trigger) { }
...
public class ConeMelee : AttackSkill
{
    ...
    public ConeMelee(ActiveSkillData data, IServiceLocator context, IServiceLocator owner, ISkillTriggerStrategy trigger) : base(data, context, owner, trigger)
    {
        _coneAngle = data.P1;
    }
...
{
    public SingleMeleeAttack(ActiveSkillData data, IServiceLocator context, IServiceLocator owner, ISkillTriggerStrategy trigger) : base(data, context, owner, trigger) { }
...
public class SingleProjectile : AttackSkill
{
    ...
    public SingleProjectile(ActiveSkillData data, IServiceLocator context, IServiceLocator owner, ISkillTriggerStrategy trigger) : base(data, context, owner, trigger) { }
...
public class SingleSummon : AttackSkill
{
    ...
    public SingleSummon(ActiveSkillData data, IServiceLocator context, IServiceLocator owner, ISkillTriggerStrategy trigger) : base(data, context, owner, trigger) { }
