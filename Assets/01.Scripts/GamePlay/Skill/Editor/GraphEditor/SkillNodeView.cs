...
public sealed class SkillNodeView : Node
{
    ...
    private void CreateExecutionBodyFields()
    {
        ...
        AddBodyFieldSlot("VFX", "VFX", typeof(SkillVfxSystem), Asset is ExecutionData execution ? execution.VFX : null);
    }
    ...
    private void DrawEffectSlot()
    {
        ...
        if (execution == null || execution.Effects == null || EffectIndex < 0 || EffectIndex >= execution.Effects.Count)
        {
